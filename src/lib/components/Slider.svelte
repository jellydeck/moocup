...
<Slider.Root
	...
	bind:value
	bind:ref
	class="relative flex w-full touch-none items-center select-none {className ?? ''}"
	{...restProps as any}
>
	...
	<Slider.Thumb
		index={0}
		class="size-5 rounded-full border bg-accent inset-shadow-[0_2px_4px_0] inset-shadow-bg/80"
	/>
</Slider.Root>
